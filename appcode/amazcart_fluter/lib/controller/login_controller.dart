...
class LoginController extends GetxController {
  ...
  bool isAdminUser() {
    ...
    // You can check by email domain, role, or any other criteria
    final userEmail = email.text.toLowerCase();
    return userEmail.contains('admin') ||
        userEmail.contains('superadmin') ||
        userEmail.endsWith('@sjfashionhub.in') ||
        userEmail == 'admin@sjfashionhub.com';
  }
  ...
  Future<dynamic> forgotPassword() async {
    var body = jsonEncode({'email': email.text});
