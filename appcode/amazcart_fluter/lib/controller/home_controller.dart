...
class HomeController extends GetxController {
  ...
  Future<void> getAllCategory() async {
    try {
      isLoading(true);
      await _dio.get(URLs.TOP_CATEGORY, queryParameters: {
  ...
  Future<void> getCategories() async {
    try {
      ...
      await _dio.get(URLs.ALL_CATEGORY, queryParameters: {
        "lang": AppLocalizations.getLanguageCode()
      }).then((value) {
  ...
  Future<void> getAllBrand() async {
    try {
      ...
      await _dio.get(URLs.ALL_BRAND, queryParameters: {
        "lang": AppLocalizations.getLanguageCode()
      }).then((value) {
        var data = Map<String, dynamic>.from(value.data);
  ...
  Future<void> getAllSlider() async {
    try {
      ...
      await _dio.get(URLs.ALL_SLIDERS, queryParameters: {
        "lang": AppLocalizations.getLanguageCode()
      }).then((value) {
        var data = Map<String, dynamic>.from(value.data);
