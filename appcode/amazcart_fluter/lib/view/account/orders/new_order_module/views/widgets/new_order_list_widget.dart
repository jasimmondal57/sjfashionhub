...
//                                                         children: [
//                                                           Text(
//                                                             ' ${currencyController.settingsModel.value.settings?.currencySymbolPosition == 'left_with_space' || currencyController.settingsModel.value.settings?.currencySymbolPosition == '' ? '${currencyController.appCurrency.value} ${(order!.packages![packageIndex].products![productIndex].price * currencyController.conversionRate.value).toStringAsFixed(2)}' : '${(order!.packages![packageIndex].products![productIndex].price * currencyController.conversionRate.value).toStringAsFixed(2)} ${currencyController.appCurrency.value}' } ',
//                                                             style: AppStyles
//                                                                 .appFontBook
//                                                                 .copyWith(
//                                                               fontSize: 12,
...
//                       'Total'.tr +
//                       ': ' +
//                       ' ${currencyController.settingsModel.value.settings?.currencySymbolPosition == 'left_with_space' || currencyController.settingsModel.value.settings?.currencySymbolPosition == '' ? '${currencyController.appCurrency.value} ${(order!.grandTotal! * currencyController.conversionRate.value).toStringAsFixed(2)}' : '${(order!.grandTotal! * currencyController.conversionRate.value).toStringAsFixed(2)} ${currencyController.appCurrency.value}' } ',
//                   style: AppStyles.appFontBook.copyWith(
//                     fontSize: 12,
//                   ),
//                 ),
