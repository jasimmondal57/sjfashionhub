...
class _ProductDetailsState extends State<ProductDetails> {
  ...
  Future<ProductDetailsModel> fetchProductDetails(id) async {
    try {
      ...
      Uri url = Uri.parse(
        URLs.ALL_PRODUCTS + '/$id?lang=${AppLocalizations.getLanguageCode()}',
      );
      ...
      if (jsonString['message'] != 'not found') {
        ...
        productReviews =
            _productDetailsModel.data?.reviews
        ...
        if ((_productDetailsModel.data?.variantDetails?.length ?? 0) > 0) {
          ...
          setState(() {
            ...
            stockCount = int.parse(
              (_productDetailsModel.data?.skus?.isNotEmpty == true
                      ? _productDetailsModel.data?.skus?.first.productStock
                            .toString()
                      : _productDetailsModel.data?.status?.toString()) ??
                  '0',
            );
          });
  ...
  double getPriceForCart() {
    String textString = currencyController.calculatePrice(
  ...
  void openCategory(dynamic category) {
    ...
    if (controller.dataFilterCat.value.filterDataFromCat != null) {
      controller.dataFilterCat.value.filterDataFromCat?.filterType?.forEach((
        element,
      ) {
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: PopupMenuButton<String>(
                                  ...
                                  onSelected: (value) {
                                    if (value == "Home") {
                                      Get.offAll(MainNavigation(navIndex: 0));
                                    }
                                    if (value == "Share") {
                                      print(
                                  ...
                                  Row(
                                    children: [
                                      if (currencyController
                                          ...
                                          "left_with_space")
                                        Text(
                                          '${currencyController.appCurrency.value} ${currencyController.calculatePrice(_productDetailsModel.data ?? ProductModel())}',
                                      ...
                                      if (currencyController
                                          ...
                                          "left_with_space")
                                        Text(
                                          '${currencyController.calculatePrice(_productDetailsModel.data ?? ProductModel())}${currencyController.appCurrency.value}',
                                          style: AppStyles.kFontPink15w5
                                              .copyWith(
                                                fontWeight: FontWeight.bold,
                                                fontSize: 18.fontSize,
                                    ...
                                    child: InkWell(
                                      onTap: () async {
                                        await Get.bottomSheet(
                                          AddToCartWidget(
                                            _productDetailsModel.data?.id ?? 0,
                                          ),
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "${(_productDetailsModel.data?.skus?.isNotEmpty == true ? (_productDetailsModel.data?.skus?.first.productStock ?? 0) : (_productDetailsModel.data?.status ?? 0)) > 0 ? "In Stock".tr : "Not in stock".tr}",
                                                  style:
                                                      AppStyles.kFontBlack14w5,
                                                ),
                                              ],
                                          ...
                                          children: [
                                            Row(
                                              ...
                                              children: [
                                                ...
                                                Text(
                                                  "${(_productDetailsModel.data?.product?.skus?.isNotEmpty == true ? _productDetailsModel.data?.product?.skus?.first.sku : null) ?? _productDetailsModel.data?.slug ?? 'N/A'}",
                                                  style:
                                                      AppStyles.kFontBlack14w5,
                                                ),
                                              ],
                                              ...
                                              child: ListView.separated(
                                                ...
                                                itemBuilder:
                                                    (
                                                      ...
                                                      ProductModel prod =
                                                          relatedProducts[relatedProductIndex];
                                          ...
                                          builder: (context) {
                                            ...
                                            return Container(
                                              ...
                                              child: ListView.separated(
                                                ...
                                                itemBuilder:
                                                    (context, crossSalesIndex) {
                                                      ProductModel prod =
                                                          crossSalesProducts[crossSalesIndex];
                                                      return HorizontalProductWidget(
                                                        productModel: prod,
                                                      );
                                                    },
                    ...
                    children: [
                      ...
                      GestureDetector(
                        onTap: () {
                          Get.to(
                            () =>
                                MainNavigation(navIndex: 0, hideNavBar: false),
                          );
                        },
                        child: Column(
                          crossAxisAlignment: CrossAxisAlignment.center,
                                  ...
                                  if (_productDetailsModel
                                    ...
                                    if (stockManage == 1) {
                                      ...
                                      Map<String, dynamic> data = {
                                        ...
                                        'price': getPriceForCart(),
                                        'seller_id':
                                            _productDetailsModel.data?.userId,
                                        'product_type': 'product',
                                        'checked': true,
                                        "in_app_purchase_id":
                                            _productDetailsModel
