                    ...
                    child: Container(
                      ...
                      child: TextField(
                        ...
                        decoration: CustomInputBorder()
                            ...
                            .copyWith(hintStyle: AppStyles.kFontBlack12w4),
                      ),
                    ),
                  );
                }),
                                      ...
                                      return InkWell(
                                        onTap: () {
                                          ...
                                          if (controller.selectedBrands
                                              .contains(brand)) {
                                            controller.selectedBrands.remove(
                                              brand,
                                            );
                                            controller
                                                .brandFilter
  ...
  Future<bool> loadData([bool isloadMoreAction = false]) async {
    ...
    try {
      ...
      if (isSorted! && !isFilter!) {
        if (this.length == 0) {
          result = await _dio.get(
            URLs.SORT_PRODUCTS + '?lang=${AppLocalizations.getLanguageCode()}',
            queryParameters: {
              'sort_by': sortKey,
              'paginate': 9,
      ...
      if (isFilter! && isSorted!) {
        ...
        controller.dataFilterCat.value.sortBy = controller.filterSortKey.value
            .toString();
