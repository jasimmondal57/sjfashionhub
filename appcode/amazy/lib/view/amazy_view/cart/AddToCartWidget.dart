...
import '../../../model/NewModel/Product/ProductVariantDetail.dart';
                                                ...
                                                : Image.network(
                                                    AppConfig.assetPath +
                                                        ...
                                                        (controller
                                                            .products
                                                            .value
                                                            .data?.product?.thumbnailImageSource??''),
                                                    height: 70,
                                                    width: 70,
                                                  )
                                      ...
                                      Container(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            ...
                                            controller
                                                        .products
                                                        .value.data?.variantDetails?.length ==
                                                    0
                                                ? Text(
                                ...
                                ListView.builder(
                                    ...
                                    itemBuilder: (context, variantIndex) {
                                      ProductVariantDetail variant = controller
                                          .products
                                          .value.data?.variantDetails?[variantIndex]??ProductVariantDetail();
