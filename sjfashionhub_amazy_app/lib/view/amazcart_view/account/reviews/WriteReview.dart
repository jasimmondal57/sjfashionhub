                              ...
                              ? ListView.builder(
                                  ...
                                  itemBuilder: (context, variantIndex) {
                                    if (productElement
                                        ...
                                        'Color') {
                                      return Text(
                                        '${'Color'.tr}: ${productElement.sellerProductSku?.productVariations?[variantIndex].attributeValue?.color?.name}',
                              ...
                              Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        '${((productElement.price??0) * currencyController.conversionRate.value).toStringAsFixed(2)}${currencyController.appCurrency.value}',
