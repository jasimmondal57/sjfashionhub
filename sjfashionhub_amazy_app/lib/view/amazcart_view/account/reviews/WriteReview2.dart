...
import 'package:sjfashionhub/controller/review_controller.dart';
...
import 'package:sjfashionhub/widgets/amazcart_widget/ButtonWidget.dart';
  ...
  Future submitReview(DIO.FormData body) async {
    ...
    try {
      ...
      response = await dio.post(
        URLs.ORDER_REVIEW + '?lang=${AppLocalizations.getLanguageCode()}',
        options: DIO.Options(
                          ...
                          productElement.type != ProductType.GIFT_CARD
                              ? ListView.builder(
                                  ...
                                  itemBuilder: (context, variantIndex) {
                                    ...
                                    var attribute =  productElement.sellerProductSku?.productVariations?[variantIndex].attribute;
                                    var attributeValue =  productElement.sellerProductSku?.productVariations?[variantIndex].attributeValue;
                              ...
                              Column(
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      Text(
                                        '${currencyController.setCurrentSymbolPosition(amount: ((productElement.price??0) * currencyController.conversionRate.value).toStringAsFixed(2))}',
                        ...
                        child: Container(
                          ...
                          child: Column(
                            children: [
                              ...
                              Text('${list[productIndex].images.length - 1}/6',style: AppStyles.kFontBlack12w4,),
                            ],
                          ),
                        ),
                      ),
            ...
            child: Column(
              children: [
                ...
                ListView.builder(
                    ...
                    itemCount: widget.package.products?.length??0,
