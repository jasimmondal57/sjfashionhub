...
import 'package:sjfashionhub/main.dart';
import 'package:sjfashionhub/model/NewModel/Product/ProductType.dart';
import 'package:sjfashionhub/utils/styles.dart';
import 'package:sjfashionhub/view/amazcart_view/account/reviews/WriteReview2.dart';
    ...
    return DefaultTabController(
      ...
      child: Builder(builder: (context) {
        ...
        return Scaffold(
          ...
          appBar: AppBarWidget(title: 'My Review'.tr),
          body: Column(
            children: [
              TabBar(
