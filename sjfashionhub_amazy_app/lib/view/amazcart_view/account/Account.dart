...
import 'package:sjfashionhub/view/amazcart_view/Settings/SettingsPage.dart';
import 'package:sjfashionhub/view/amazcart_view/account/MyGiftCardsPage.dart';
import 'package:sjfashionhub/view/amazcart_view/account/WishList.dart';
import 'package:sjfashionhub/view/amazcart_view/account/coupons/MyCoupons.dart';
import 'package:sjfashionhub/view/amazcart_view/account/orders/MyCancellations.dart';
import 'package:sjfashionhub/view/amazcart_view/account/orders/RefundAndDisputes/MyRefundsAndDisputes.dart';
import 'package:sjfashionhub/view/amazcart_view/account/reviews/MyReviews.dart';
import 'package:sjfashionhub/view/amazcart_view/support/SupportTicketsPage.dart';
...
class Account extends StatefulWidget {
  const Account({super.key, this.enableBackButton = false});
      ...
      body: CustomScrollView(
        slivers: [
          SliverAppBar(
            ...
            titleSpacing: 0,
            leading: widget.enableBackButton? AppBarBackButton(color: Colors.white) : null,
            centerTitle: true,
                              ...
                              InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: loginController
                                          ...
                                          null
                                      ? Text(
                                          'Wallet'.tr + ': ${currencyController.setCurrentSymbolPosition(amount: (loginController.accountController.customerData.value.walletRunningBalance! * currencyController.conversionRate.value).toStringAsFixed(2))}',
                                          textAlign: TextAlign.left,
