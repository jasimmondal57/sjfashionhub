...
import 'package:sjfashionhub/model/MyCouponsModel.dart';
                          ...
                          ? Column(
                              children: [
                                ...
                                widget.coupon!.minimumShopping != null
                                    ? Text(
                                        'Spend'.tr +
                                            ' ${currencyController.setCurrentSymbolPosition(amount: double.parse((currencyController.conversionRate.value * (widget.coupon?.minimumShopping??0)).toString()).toStringAsFixed(2))} ' +
                                            'get'.tr +
                                            ' ${currencyController.setCurrentSymbolPosition(amount: double.parse((currencyController.conversionRate.value * (widget.coupon?.maximumDiscount??0)).toString()).toStringAsFixed(2))} off',
                                        style: AppStyles.appFont.copyWith(
                                          color: AppStyles.pinkColor,
                                          fontSize: 14.fontSize,
                                          fontWeight: FontWeight.w400,
