...
import 'package:sjfashionhub/model/NewModel/Cart/MyCheckoutModel.dart';
import 'package:sjfashionhub/model/NewModel/Cart/FlatGst.dart';
...
import 'package:sjfashionhub/model/NewModel/ShippingMethodModel.dart';
import 'package:sjfashionhub/utils/styles.dart';
import 'package:sjfashionhub/view/amazcart_view/cart/GatewaySelection.dart';
import 'package:sjfashionhub/view/amazcart_view/settings/AddAddress.dart';
import 'package:sjfashionhub/view/amazcart_view/settings/AddressBook.dart';
import 'package:sjfashionhub/widgets/amazcart_widget/AppBarWidget.dart';
import 'package:sjfashionhub/widgets/amazcart_widget/CustomDate.dart';
...
class _CartCheckoutState extends State<CartCheckout> {
  ...
  List<String> _status = ["Home Delivery", "Pickup Location"];
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      appBar: AppBarWidget(title: 'Checkout'.tr),
      body: Scrollbar(
        ...
        child: ListView(
          ...
          children: [
            ...
            Obx(() {
              log(
                "checkoutController.checkoutModel.value.packages :::${checkoutController.checkoutModel.value.packages?.length}",
              );
              if (checkoutController.isLoading.value) {
                    ...
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, packageIndex) {
                            ...
                            ?.forEach((element) {
                              if (element.productType == ProductType.PRODUCT) {
                                totalWeight += double.parse(
                                  element.product?.sku?.weight ?? "0.0",
                                ).toDouble();
                                totalHeight += double.parse(
                                  element.product?.sku?.height ?? "0.0",
                                ).toDouble();
                                totalLength += double.parse(
                                  element.product?.sku?.length ?? "0.0",
                                ).toDouble();
                                totalBreadth += double.parse(
                                  element.product?.sku?.breadth ?? "0.0",
                                ).toDouble();
                              }
                            });

                        final Map<dynamic, dynamic> packageWiseWeightMap =
                            checkoutController.orderData['package_wise_weight'];
                        final Map<dynamic, dynamic> packageWiseHeightMap =
                            checkoutController.orderData['package_wise_height'];
                        final Map<dynamic, dynamic> packageWiseLengthMap =
                            checkoutController.orderData['package_wise_length'];
                        ...
                        checkoutController.checkoutModel.value.packages
                            ?.forEach((key, value) {
                              addValueToMap(
                                packageWiseWeightMap,
                                '$packageIndex',
                                totalWeight,
                              );
                              addValueToMap(
                                packageWiseHeightMap,
                                '$packageIndex',
                                totalHeight,
                              );
                              addValueToMap(
                                packageWiseLengthMap,
                                '$packageIndex',
                                totalLength,
                              );
                              addValueToMap(
                                packageWiseBreadthMap,
                                '$packageIndex',
                                totalBreadth,
                              );
                            });
                            ...
                            ?.forEach((element) {
                              ...
                              if (element.product?.product?.product?.gstGroup ==
                                    ...
                                    if (currencyController
                                        ...
                                        if (element
                                          ...
                                          checkoutController
                                              ...
                                              ?.forEach((same) {
                                                ...
                                                gstS =
                                                    '${same.name}(${same.taxPercentage} %) : ${currencyController.setCurrentSymbolPosition(amount: gst.toString())}';
                                          ...
                                          checkoutController
                                              ...
                                              ?.forEach((diff) {
                                                ...
                                                gstS =
                                                    '${diff.name}(${diff.taxPercentage} %) : ${currencyController.setCurrentSymbolPosition(amount: gst.toString())}';
                                                gstShowList.add(gstS);
                                                gstID.add(diff.id);
                                                gstAmount.add(gst);
                                              });
                                      ...
                                      if ((element
                                        ...
                                        if (element
                                          ...
                                          gstS =
                                              '${checkoutController.checkoutModel.value.flatGst?.name}(${checkoutController.checkoutModel.value.flatGst?.taxPercentage} %) : ${currencyController.setCurrentSymbolPosition(amount: gst.toString())}';
                                          gstShowList.add(gstS);
                                          gstAmount.add(gst);
                                        } else {
                                          checkoutController
                                ...
                                sameState.entries.forEach((element) {
                                  totalSameStateGst += double.parse(
                                    element.value.toString(),
                                  ).toPrecision(2);
                                });
                                outsideState.entries.forEach((element) {
                                  totalOutsideStateGst += double.parse(
                                    element.value.toString(),
                                  ).toPrecision(2);
                                });
                                ...
                                children: [
                                                      ...
                                                      children: [
                                                        ...
                                                        additionalShipping > 0.0
                                                            ? Text(
                                                                'Additional Shipping'
                                                                        .tr +
                                                                    ': ${currencyController.setCurrentSymbolPosition(amount: (additionalShipping * currencyController.conversionRate.value).toString())}',
                                                                style: AppStyles
                                                                    .kFontGrey12w5,
                                                              )
                                                            : Container(),
                                  ...
                                  ListView.separated(
                                    ...
                                    itemBuilder: (context, productIndex) {
                                      ...
                                      log(
                                        "image path ::${AppConfig.assetPath}/${checkoutItem[productIndex].product?.product?.product?.thumbnailImageSource}",
                                      );
                                                                ...
                                                                children: [
                                                                  ...
                                                                  checkoutItem[productIndex]
                                                                      ...
                                                                      ? ListView.builder(
                                                                          ...
                                                                          itemCount: checkoutItem[productIndex]
                                                                              .product
                                                                              ?.productVariations
                                                                              ?.length,
                                                                          itemBuilder:
                                                                              (
                                                                                ...
                                                                                if (checkoutItem[productIndex].product?.productVariations?[variationIndex].attribute?.name ==
                                                                                    'Color') {
                                                                                  return Text(
                                                                  ...
                                                                  Wrap(
                                                                    ...
                                                                    children: [
                                                                      ...
                                                                      checkoutItem[productIndex].productType ==
                                                                              ProductType.PRODUCT
                                                                          ? checkoutItem[productIndex].product?.product?.hasDiscount ==
                                                                                    "yes"
                                                                                ? Row(
                                                                                    children: [
                                                                                      Text(
                                                                                        '${currencyController.setCurrentSymbolPosition(amount: double.parse(((checkoutItem[productIndex].price ?? 0) * currencyController.conversionRate.value).toString()).toStringAsFixed(2))}',
                                                                                      ...
                                                                                      Text(
                                                                                        '${currencyController.setCurrentSymbolPosition(amount: double.parse((checkoutItem[productIndex].product?.sellingPrice * currencyController.conversionRate.value).toString()).toStringAsFixed(2))}',
                                                                          ...
                                                                          : (checkoutItem[productIndex].giftCard?.endDate?.millisecondsSinceEpoch ??
                                                                                    0) >
                                                                          ...
                                                                          ? Row(
                                                                              children: [
                                                                                ...
                                                                                Text(
                                                                                  '${currencyController.setCurrentSymbolPosition(amount: double.parse(((checkoutItem[productIndex].giftCard?.sellingPrice ?? 1) * currencyController.conversionRate.value).toString()).toStringAsFixed(2))}',
                                                                                  style: AppStyles.kFontGrey12w5.copyWith(
                                                                                    decoration: TextDecoration.lineThrough,
                                                                                  ),
                                                                                ),
                                                                      ...
                                                                      checkoutItem[productIndex].productType ==
                                                                              ProductType.PRODUCT
                                                                          ? checkoutItem[productIndex].product?.product?.hasDeal !=
                                                                                    null
                                                                                ? Row(
                                                                                    children: [
                                                                                      Container(
                                                                                        ...
                                                                                        child: Text(
                                                                                          checkoutItem[productIndex].product?.product?.hasDeal?.discountType ==
                                                                                                  0
                                                                                              ? '-${checkoutItem[productIndex].product?.product?.hasDeal?.discount}%'
                                                                                              : '-${currencyController.setCurrentSymbolPosition(amount: double.parse(((checkoutItem[productIndex].product?.product?.hasDeal?.discount ?? 0) * currencyController.conversionRate.value).toString()).toStringAsFixed(2))}',
                                                                                          style: AppStyles.kFontWhite12w5,
                                                                                        ),
                                                                                      ),
                                                                                    ],
                                                                                  )
                                                                                : (checkoutItem[productIndex].product?.product?.discount ??
                                                                                          0) >
                                                                                      0
                                                                                ? Row(
                                                                                    children: [
                                                                                      Container(
                                                                                        ...
                                                                                        child: Text(
                                                                                          checkoutItem[productIndex].product?.product?.discountType ==
                                                                                                  "0"
                                                                                              ? '-${checkoutItem[productIndex].product?.product?.discount}%'
                                                                                              : '-${currencyController.setCurrentSymbolPosition(amount: double.parse(((checkoutItem[productIndex].product?.product?.discount ?? 0) * currencyController.conversionRate.value).toString()).toStringAsFixed(2))}',
                                                                                          style: AppStyles.kFontWhite12w5,
                                                                                        ),
                                                                                      ),
                                                                                    ],
                                                                                ...
                                                                                : Container()
                                                                          : (checkoutItem[productIndex].giftCard?.discount ??
                                                                                    0) >
                                                                                DateTime.now().millisecondsSinceEpoch
                                                                          ? Row(
                                                                              children: [
                                                                                Container(
                                                                                  ...
                                                                                  child: Text(
                                                                                    checkoutItem[productIndex].giftCard?.discountType ==
                                                                                                "0" ||
                                                                                            checkoutItem[productIndex].giftCard?.discountType ==
                                                                                                0
                                                                                        ? '-${checkoutItem[productIndex].giftCard?.discount}%'
                                                                                        : '-${currencyController.setCurrentSymbolPosition(amount: double.parse(((checkoutItem[productIndex].giftCard?.discount ?? 0) * currencyController.conversionRate.value).toString()).toStringAsFixed(2))}',
                                                                                    style: AppStyles.kFontWhite12w5,
                                                                                  ),
                                                                                ),
                                                                              ],
                                          ...
                                          children: [
                                            Padding(
                                              ...
                                              child: Text(
                                                '$qty ' +
                                                    "${"Item(s)".tr}, ${"Total".tr}:" +
                                                    '${currencyController.setCurrentSymbolPosition(amount: double.parse((price * currencyController.conversionRate.value).toString()).toStringAsFixed(2))}',
                      ...
                      children: [
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              '${currencyController.setCurrentSymbolPosition(amount: (checkoutController.subTotal.value * currencyController.conversionRate.value).toStringAsFixed(2))}',
                              style: AppStyles.kFontBlack14w5,
                            ),
                          ],
                        ),
                            ...
                            ? Container(
                                ...
                                child: Row(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      '${currencyController.setCurrentSymbolPosition(amount: (checkoutController.shipping.value * currencyController.conversionRate.value).toStringAsFixed(2))}',
                                      style: AppStyles.kFontBlack14w5,
                                    ),
                                  ],
                                ),
                        ...
                        Row(
                          ...
                          children: [
                            ...
                            Text(
                              '-${currencyController.setCurrentSymbolPosition(amount: (checkoutController.discountTotal.value * currencyController.conversionRate.value).toStringAsFixed(2))}',
                              style: AppStyles.kFontBlack14w5,
                            ),
                          ],
                        ),
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      Text(
                                        '${currencyController.setCurrentSymbolPosition(amount: (checkoutController.gstTotal.value * currencyController.conversionRate.value).toStringAsFixed(2))}',
                                        style: AppStyles.kFontBlack14w5,
                                      ),
                                    ],
                                  ),
                        ...
                        checkoutController.couponApplied.value
                            ? Row(
                                ...
                                children: [
                                  ...
                                  Text(
                                    '${currencyController.setCurrentSymbolPosition(amount: (checkoutController.couponDiscount.value * currencyController.conversionRate.value).toStringAsFixed(2))}',
                          ...
                          children: [
                            Text(
                              '${checkoutController.totalQty} ' +
                                  '${"Item(s)".tr}, ${"Grand Total".tr}:' +
                                  ' ' +
                                  '${currencyController.setCurrentSymbolPosition(amount: (checkoutController.grandTotal.value * currencyController.conversionRate.value).toStringAsFixed(2))}',
                              style: AppStyles.kFontBlack14w5,
                            ),
                          ],
                        ),
                  ...
                  PinkButtonWidget(
                    ...
                    btnOnTap: () async {
                      if (addressController.addressCount.value == 0) {
                        ...
                        log(
                          jsonEncode(checkoutController.orderData).toString(),
                        );
...
class _ShippingDropDownState extends State<ShippingDropDown> {
    ...
    if (arr.contains('days')) {
      ...
      arr =
          ...
          CustomDate().formattedDateOnly(
            DateTime.now().add(Duration(days: int.parse(arr.split('-').first))),
          ) +
          '-' +
          CustomDate().formattedDateOnly(
            DateTime.now().add(Duration(days: int.parse(arr.split('-').last))),
          );
    } else {
  ...
  void initState() {
    ...
    checkoutController.checkoutModel.value.packages?.forEach((key, value) {
      value.items?.forEach((CheckoutItem itemEl) {
        if (itemEl.productType == ProductType.PRODUCT) {
          additionalShipping += itemEl.product?.sku?.additionalShipping ?? 0;
        }
      });
    });
    ...
    if (widget.shippingValue?.costBasedOn == 'Price') {
      if (widget.price! > 0) {
        shippingCost2 =
            (widget.price! / 100) * (widget.shippingValue?.cost ?? 0) +
            additionalShipping;
      }
    } else if (widget.shippingValue?.costBasedOn == 'Weight') {
      if ((widget.totalWeight ?? 0) > 0) {
        shippingCost2 =
            ((widget.totalWeight ?? 0) / 100) *
                (widget.shippingValue?.cost ?? 0) +
            additionalShipping;
      }
    } else {
      ...
      child: DropdownButton<Shipping>(
        ...
        items: widget.shippings?.map((e) {
          ...
          if (e.costBasedOn == 'Price') {
            if ((widget.price ?? 0) > 0) {
              shippingCost =
                  (((widget.price ?? 0) / 100) * (e.cost ?? 0)) +
                  additionalShipping;
            }
          } else if (e.costBasedOn == 'Weight') {
            if ((widget.totalWeight ?? 0) > 0) {
              shippingCost =
                  (((widget.totalWeight ?? 0) / 100) * (e.cost ?? 0)) +
                  additionalShipping;
            }
          } else {
            if ((e.cost ?? 0) > 0) {
              ...
              children: [
                Row(
                  children: [
                    ...
                    Spacer(),
                    Text(
                      "${currencyController.setCurrentSymbolPosition(amount: double.parse("${shippingCost * currencyController.conversionRate.value}").toStringAsFixed(2))}",
                      style: AppStyles.kFontBlack14w5.copyWith(
                        fontWeight: FontWeight.w600,
                      ),
                    ),
                ...
                currencyController.vendorType.value == "single"
                    ? Container(
                        ...
                        child: Text(
                          "${"Minimum shopping amount".tr} (${"without shipping cost".tr}): ${currencyController.setCurrentSymbolPosition(amount: double.parse("${(e.minimumShopping ?? 0) * currencyController.conversionRate.value}").toStringAsFixed(2))}",
                          style: AppStyles.kFontBlack14w5.copyWith(
                            fontSize: 12,
                          ),
                        ),
          ...
          if (currencyController.vendorType.value == "single") {
            if (!((value?.minimumShopping ?? 0) >=
              ...
              setState(() {
                ...
                checkoutController.shipping.value = totalShipping.toPrecision(
                  2,
                );
