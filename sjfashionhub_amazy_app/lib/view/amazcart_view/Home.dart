...
import 'package:sjfashionhub/view/amazcart_view/marketing/AllTopPickProducts.dart';
import 'package:sjfashionhub/view/amazcart_view/marketing/FlashDealView.dart';
import 'package:sjfashionhub/view/amazcart_view/marketing/NewUserZone/NewUserZonePage.dart';
import 'package:sjfashionhub/view/amazcart_view/products/AllCategorySubCategory.dart';
import 'package:sjfashionhub/view/amazcart_view/products/RecommendedProductLoadMore.dart';
import 'package:sjfashionhub/view/amazcart_view/products/brand/AllBrandsPage.dart';
import 'package:sjfashionhub/view/amazcart_view/products/brand/ProductsByBrands.dart';
import 'package:sjfashionhub/view/amazcart_view/products/category/ProductsByCategory.dart';
import 'package:sjfashionhub/view/amazcart_view/products/product/ProductDetails.dart';
import 'package:sjfashionhub/view/amazcart_view/products/tags/ProductsByTags.dart';
import 'package:sjfashionhub/widgets/amazcart_widget/BuildIndicatorBuilder.dart';
import 'package:sjfashionhub/widgets/amazcart_widget/GridViewProductWidget.dart';
import 'package:sjfashionhub/widgets/amazcart_widget/HomeTitlesWidget.dart';
import 'package:sjfashionhub/widgets/amazcart_widget/HorizontalProductWidget.dart';
import 'package:sjfashionhub/widgets/amazcart_widget/custom_input_border.dart';
import 'package:sjfashionhub/widgets/amazcart_widget/fa_icon_maker/fa_custom_icon.dart';
                        ...
                        Obx(
                          () => _homeController.isHomePageLoading.value
                              ...
                              : _homeController.homePageModel.value.sliders ==
                                          null ||
                                      _homeController
                                          .homePageModel.value.sliders!.isEmpty
                                  ? SizedBox.shrink()
                                  : ClipRRect(
                                      borderRadius:
                                          BorderRadius.all(Radius.circular(5)),
                          ...
                          if (!_homeController.isHomePageLoading.value) {
                            ...
                            return ListView(
                              ...
                              children: [
                                ...
                                Container(
                                  child: _homeController.homePageModel.value
                                                  .topCategories ==
                                              null ||
                        ...
                        Obx(() {
                          if (_homeController.isHomePageLoading.value) {
                            ...
                            if (_homeController.hasDeal.value) {
                              if (_homeController.homePageModel.value.flashDeal
                                      ?.allProducts?.isEmpty ??
                                  true) {
                                return SizedBox();
                              }
