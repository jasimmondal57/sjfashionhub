...
import 'package:sjfashionhub/widgets/amazcart_widget/BlueButtonWidget.dart';
...
class _CategoryFilterDrawerState extends State<CategoryFilterDrawer> {
  ...
  void initState() {
    if (controller.catAllData.value.lowestPrice != null &&
        ((controller.catAllData.value.lowestPrice??0) <
            (controller.catAllData.value.heightPrice??0))) {
      showRange = true;

      _lowerValue = (controller.catAllData.value.lowestPrice??0).toDouble();
      _upperValue = (controller.catAllData.value.heightPrice??0).toDouble();
                              ...
                              ? Builder(
                                  builder: (context) {
                                    final _items = controller.catAllData.value
                                        ...
                                        ?.map((attribute) => MultiSelectItem<FilterAttributeValue>(
                                              ...
                                              onPressed: () async {
                                                ...
                                                if (controller.selectedAttribute
                                                  ...
                                                  await controller
                                                      .addFilterAttribute(
                                                          isColor: false,
                                                          value: item.value??FilterAttributeValue(),
                                                          typeId: controller
                                                              .catAllData
                                                              .value
                                                              .attributes?[
                                  ...
                                  onTap: () async {
                                    ...
                                    if (controller.selectedColorValue
                                      ...
                                      await controller.addFilterAttribute(
                                          isColor: true,
                                          colorValue: item.value??FilterColorValue(),
                                          typeId: controller
                                              .catAllData.value.color?.id ?? ''
            ...
            showRange
                ? Padding(
                    ...
                    child: FlutterSlider(
                      ...
                      min: (controller.catAllData.value.lowestPrice??0).toDouble(),
                      max: (controller.catAllData.value.heightPrice??0).toDouble(),
                      onDragCompleted:
