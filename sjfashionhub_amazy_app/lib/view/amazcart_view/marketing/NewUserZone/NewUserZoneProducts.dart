...
import 'package:sjfashionhub/model/NewUserZoneModel.dart';
      ...
      child: Container(
        ...
        child: Column(
          ...
          children: [
            Padding(
              padding:
                  EdgeInsets.only(left: 10.0.w, bottom: 15.0.h, right: 10.w, top: 15.h),
              child: Text(
              ...
              child: LoadingMoreList<NewUserZoneDatum>(
                ListConfig<NewUserZoneDatum>(
                  ...
                  itemBuilder:
                    ...
                    return GridViewProductWidget(productModel: prod.product??ProductModel());
                  },
                  sourceList: source!,
                ),
              ),
...
class NewUserZoneAllProductsLoadMore extends LoadingMoreBase<NewUserZoneDatum> {
  ...
  @override
  bool get hasMore => (_hasMore && length < (newUserZoneController.newZone.value.newUserZone?.allProducts?.data?.length??0)) || forceRefresh;
