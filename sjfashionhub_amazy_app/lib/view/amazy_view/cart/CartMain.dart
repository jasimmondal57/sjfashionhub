                          ...
                          itemBuilder: (context, index) {
                            ...
                            try {
                              if (cartItems[index].product != null &&
                                  ...
                                  cartItems[index].product?.product?.reviews !=
                                      null &&
                                  (cartItems[index].product?.product?.reviews ??
                                          [])
                                      .isNotEmpty) {
                                ...
                                children: [
                                                ...
                                                child: Container(
                                                  ...
                                                  child: Row(
                                                    children: [
                                                      Flexible(
                                                        child: Text(
                                                          "${cartItems.isNotEmpty ? cartItems[0].seller?.name ?? '' : ''}",
                                                          style: AppStyles
                                                              .appFontMedium
                                                              .copyWith(
                                                                color: AppStyles
                                  ...
                                  Column(
                                    children: List.generate(cartItems.length, (
                                      ...
                                      if (cartItems[prodIndex].product !=
                                              null &&
                                          cartItems[prodIndex]
                                                  .product
                                                  ?.product !=
                                                              ...
                                                              child: FancyShimmerImage(
                                                                imageUrl:
                                                                    ...
                                                                    (cartItems[prodIndex].product!.sku!.variantImage ==
                                                                            null
                                                                        ? cartItems[prodIndex].product?.product?.product?.thumbnailImageSource ??
                                                                              ''
                                                                        : cartItems[prodIndex].product?.sku?.variantImage ??
                                                                              ''),
                                                                boxFit: BoxFit
                                                        ...
                                                        cartItems[prodIndex]
                                                            ...
                                                            ? cartItems[prodIndex]
                                                                  ...
                                                                  ? cartItems[prodIndex].qty ==
                                                                            cartItems[prodIndex].product!.productStock
                                                                        ? Icon(
                                                                            Icons.add,
                                                                            color:
              ...
              return cartController.deleteSelected.value
                  ? Column(
                      children: [
                        ...
                        GestureDetector(
                          onTap: () async {
                            cartController.cartItemDelete.forEach((
                              element,
                            ) async {
