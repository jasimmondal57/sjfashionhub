...
import 'package:sjfashionhub/view/amazy_view/authentication/OtpVerificationPage.dart';
import 'package:sjfashionhub/view/amazy_view/payment/bank_payment_sheet.dart';
import 'package:sjfashionhub/view/amazy_view/payment/instamojo_payment.dart';
import 'package:sjfashionhub/view/amazy_view/payment/jazzcash.dart';
import 'package:sjfashionhub/view/amazy_view/payment/midtrans_payment.dart';
import 'package:sjfashionhub/view/amazy_view/payment/paypal/paypal_payment.dart';
import 'package:sjfashionhub/view/amazy_view/payment/paytm_service.dart';
import 'package:sjfashionhub/view/amazy_view/payment/razorpay_sheet.dart';
import 'package:sjfashionhub/view/amazy_view/payment/stripe/stripe_payment.dart';
import 'package:sjfashionhub/view/amazy_view/payment/gpay_service.dart';
  ...
  setSelectedMethod(Gateway gateWay) {
    ...
    if (controller.selectedGateway.value.id == 13) {
      _paymentItems.add(PaymentItem(
        ...
        label: "${AppConfig.appName}" + "Order".tr,
