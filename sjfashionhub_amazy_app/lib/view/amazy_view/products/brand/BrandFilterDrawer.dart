...
import 'package:sjfashionhub/view/amazy_view/products/brand/brand_controller.dart';
import 'package:sjfashionhub/widgets/amazy_widget/PinkButtonWidget.dart';
import 'package:flutter/material.dart';
import 'package:flutter_rating_bar/flutter_rating_bar.dart';
import 'package:flutter_xlider/flutter_xlider.dart';
import 'package:get/get.dart';
import 'package:sjfashionhub/widgets/amazy_widget/BlueButtonWidget.dart';
import 'package:multi_select_flutter/multi_select_flutter.dart';

import '../../../../model/NewModel/Category/CategoryData.dart';
import '../../../../model/NewModel/Filter/FilterAttributeValue.dart';
import '../../../../model/NewModel/Filter/FilterColor.dart';
          ...
          children: [
              ...
              builder: (context) {
                ...
                return MultiSelectChipField<CategoryData?>(
                  ...
                  itemBuilder: (item, state) {
                    return Card(
                      color: controller!.selectedBrandCat.contains(item.value)
                          ? AppStyles.darkBlueColor
                          : Colors.white,
                      elevation: controller!.selectedBrandCat.contains(item.value)
                          ? 5
                          : 3,
                        ...
                        child: MaterialButton(
                          onPressed: () async {
                            ...
                            if (controller!.selectedBrandCat.contains(item.value)) {
                              ...
                              controller!.subCatFilter.value.filterTypeValue!
                                  .remove(item.value!.id.toString());

                              controller!.dataFilterCat.value
                                  .filterDataFromCat?.filterType?.where((element) =>
                              ...
                              controller!.dataFilterCat.value
                                  .filterDataFromCat?.filterType?.add(controller!.subCatFilter.value);
            ...
            (controller!.brandAllData.value.attributes?.length??0) > 0
                ? ListView.builder(
                    ...
                    itemCount: controller!.brandAllData.value.attributes?.length??0,
                          ...
                          return MultiSelectChipField<FilterColorValue?>(
                            ...
                            itemBuilder: (item, state) {
                              ...
                              if (!item.value!.value!.contains('#')) {
                                bgColor = AppStyles.colourNameToHex(item.value!.value);
                              } else {
                                bgColor = AppStyles.getBGColor(item.value!.value!);
                              }
                              return Container(
                                height: 30,
                                        ...
                                        Positioned.fill(
                                          child: Container(
                                            ...
                                            decoration: BoxDecoration(
                                              ...
                                              border: Border.all(
                                                width: controller!.selectedBrandColorValue
                                                    .contains(item.value)
                                                    ? 3
                                                    : 0.1,
                                                color: controller!.selectedBrandColorValue
                                                    .contains(item.value)
                                                    ? Colors.pink
                                                    : Colors.black,
                                              ),
