...
import 'package:sjfashionhub/view/amazy_view/authentication/ForgotPassword.dart';
            ...
            child: Column(
              ...
              children: [
                ...
                Row(
                  ...
                  crossAxisAlignment: CrossAxisAlignment.center,
                  children: [
                    Image.asset(AppConfig.appLogo, width: 33.w, height: 33.w),
                    SizedBox(width: 5),
                    Text(
                      AppConfig.appName,
...
class FacebookResponse {
  FacebookResponse({this.userId, this.token});
...
class FacebookUser {
  FacebookUser({this.email, this.id, this.name});
