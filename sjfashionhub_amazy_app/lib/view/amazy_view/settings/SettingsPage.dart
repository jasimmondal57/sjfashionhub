...
import 'package:sjfashionhub/view/amazy_view/settings/ChangePassword.dart';
import 'package:sjfashionhub/view/amazy_view/settings/MessagesSettings.dart';
import 'package:sjfashionhub/view/amazy_view/settings/widget/account_delete_dialogue.dart';
...
class _SettingsPageState extends State<SettingsPage> {
  ...
  void initState() {
    if (languages.isNotEmpty) {
      ...
      LanguageModel languageModel = index >= 0
          ? languages[index]
          : languages.first;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBarWidget(title: 'Settings'.tr, showCart: false),
      body: Obx(() {
        return Container(
          child: ListView(
            children: [
              ...
              loginController.loggedIn.value
                  ...
                  : Container(),
              loginController.loggedIn.value
                  ? Divider(color: AppStyles.appBackgroundColor, height: 1)
                  : Container(),
              loginController.loggedIn.value
                  ? ListTile(
                      onTap: () {
                                      ...
                                      title: DropdownButton<LanguageModel>(
                                        ...
                                        onChanged: (value) async {
                                          ...
                                          try {
                                            ...
                                            _homeController.source?.refresh(
                                              true,
                                            );
