...
import 'package:sjfashionhub/widgets/amazy_widget/SettingsListTileWidget.dart';
import 'package:sjfashionhub/widgets/amazy_widget/SettingsModalWidget.dart';
      ...
      if (response.statusCode == 202) {
        ...
        if (response.statusCode == 401) {
          SnackBars().snackBarWarning(
              'Invalid Access token. Please re-login.'.tr);
          return false;
        } else {
