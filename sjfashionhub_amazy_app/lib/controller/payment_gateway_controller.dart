...
import 'package:sjfashionhub/model/NewModel/BankInformationModel.dart';
...
import 'package:sjfashionhub/model/PaymentStoreModel.dart';
import 'package:sjfashionhub/view/amazcart_view/account/orders/OrderList/MyOrders.dart';
  ...
  Future<PaymentGatewayModel> getGatewayList() async {
    ...
    try {
      ...
      if (gateways != null) {
        ...
        int index = gatewayList.indexWhere((v)=> v.method == "In app purchase");
        if(index != -1){
          gatewayList.removeAt(index);
        }
