      ...
      if (widget.productModel.discountType == 0 ||
        ...
        productPrice =
            ...
            (((widget.productModel.discount ?? 0) / 100) *
                (widget.productModel.giftCardSellingPrice ?? 1.0)));
      } else {
        productPrice =
            ((widget.productModel.giftCardSellingPrice ?? 0) -
      ...
      onTap: () async {
        ...
        if (widget.productModel.productType == ProductType.PRODUCT) {
          if ((widget.productModel.variantDetails ?? []).length == 0) {
              ...
              if ((widget.productModel.skus?.first.productStock ?? 0) > 0) {
                if ((widget.productModel.product?.minimumOrderQty ?? 0) >
                  ...
                  Map<String, dynamic> data = {
                    ...
                    'checked': true,
                    "in_app_purchase_id":
                        widget.productModel.skus?.first.inAppPurchaseId,
                  };

                  if (Platform.isIOS &&
                      (widget.productModel.product?.isPhysical == 0 ||
            ...
            Get.to(
              () => ProductDetails(productID: widget.productModel.id),
          ...
          Map<String, dynamic> data = {
            ...
            "in_app_purchase_id": widget.productModel.skus?.isNotEmpty == true
                ? widget.productModel.skus!.first.inAppPurchaseId
                : null,
          };
