...
mixin URLs {
  ...
  static const String API_URL = HOST + '/api/api';
  ...
  static String ALL_ORDER_LIST_BY_STATUS({required int id}) =>
      '$API_URL/order-by-delivery-status?status=$id&lang=${AppLocalizations.getLanguageCode()}';
  static const String ALL_ORDER_DELIVERY_PROCESS =
      '$API_URL/delivery-processes';
  ...
  static const String getLang = '$API_URL/get-lang';
  static const String setLang = '$API_URL/set-lang';

  ///In-app purchase APIs
  static const String inAppPurchaseAddToCart = "$API_URL/in-app-cart-store";
  static const String createInAppPurchaseOrder =
      "$API_URL/order-store/in-app-purchase";
