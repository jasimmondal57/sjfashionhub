...
class UserObserver
{
    ...
    public function created(User $user): void
    {
        try {
            ...
            // Only send welcome notifications to customers (not admin users)
            if ($user->role === 'customer' || !$user->role) {
                EmailNotificationService::sendWelcomeNotifications($user);
                Log::info("Welcome notifications sent to user: {$user->email}");
            }
        } catch (\Exception $e) {
