                        ...
                        <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden group hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                            ...
                            <div class="p-4">
                                ...
                                <div class="flex space-x-2">
                                    ...
                                    @endphp
                                    <button onclick="addToCartWithAnimation({{ $product->id }}, this, {{ $hasVariants ? 'true' : 'false' }}, '{{ $product->slug }}')" class="cart-button flex-1 text-xs py-2 px-3 rounded transition-colors" style="background-color: #111827 !important; color: white !important; border: none !important;" onmouseover="this.style.backgroundColor='#374151'" onmouseout="this.style.backgroundColor='#111827'">
                                    ...
                                    <button onclick="buyNow({{ $product->id }}, {{ $hasVariants ? 'true' : 'false' }}, '{{ $product->slug }}')" class="flex-1 text-xs py-2 px-3 rounded transition-colors" style="background-color: #4f46e5 !important; color: white !important; border: none !important;" onmouseover="this.style.backgroundColor='#4338ca'" onmouseout="this.style.backgroundColor='#4f46e5'">
                                        Buy Now
                                    </button>
                                </div>
                            </div>
