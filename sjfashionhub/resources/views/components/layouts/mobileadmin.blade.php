        ...
        <div class="hidden lg:flex lg:flex-shrink-0">
            <div class="flex flex-col w-64 bg-gradient-to-b from-purple-900 to-indigo-900">
                ...
                <nav class="flex-1 px-2 py-4 space-y-1 overflow-y-auto">
                    ...
                    <a href="{{ route('mobileadmin.featured-categories.index') }}"
                       class="flex items-center px-4 py-3 text-sm font-medium rounded-lg transition-colors {{ request()->routeIs('mobileadmin.featured-categories*') ? 'bg-white bg-opacity-20 text-white' : 'text-purple-100 hover:bg-white hover:bg-opacity-10' }}">
