<x-layouts.admin title="Create Hero Section" description="Create a new hero section">
    <div class="space-y-6">
        <!-- Header -->
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-2xl font-bold text-black">Create Hero Section</h1>
                <p class="text-gray-600">Design a new hero section for your website</p>
            </div>
        ...
        <form action="{{ route('admin.hero-sections.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
            ...
            <div class="bg-white rounded-lg border border-gray-100 p-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <input type="text" 
                               id="title" 
                               name="title" 
                               value="{{ old('title', 'Where Elegance') }}"
                    ...
                    <div>
                        ...
                        <input type="text" 
                               id="subtitle" 
                               name="subtitle" 
                               value="{{ old('subtitle', 'Meets Comfort') }}"
                               class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
                               required>
                        @error('subtitle')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                ...
                <div class="mt-6">
                    ...
                    <textarea id="description" 
                              ...
                              rows="3"
                              class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
                              required>{{ old('description', 'Refined Style, Perfect Fit. Style Made Effortless. Elevate Your Style Everyday.') }}</textarea>
                    @error('description')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
            ...
            <div class="bg-white rounded-lg border border-gray-100 p-6">
                ...
                <div id="buttons-container" class="{{ old('show_buttons', true) ? '' : 'hidden' }}">
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <!-- Primary Button -->
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('primary_button_text', 'Shop Now') }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent"
                                       required>
                            ...
                            <div>
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('primary_button_url', '/products') }}"
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <input type="text" 
                                       ...
                                       value="{{ old('secondary_button_text', 'Browse Categories') }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent">
                            ...
                            <div>
                                ...
                                <input type="text"
                                       ...
                                       value="{{ old('secondary_button_url', '/categories') }}"
                                       class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent mt-2"
            ...
            <div class="bg-white rounded-lg border border-gray-100 p-6">
                    ...
                    <div>
                        ...
                        <div class="flex items-center space-x-3">
                            <input type="color" 
                                   ...
                                   value="{{ old('background_color', '#f9fafb') }}"
                ...
                <div class="mt-6 grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                        ...
                        <select id="layout_style" 
                                name="layout_style" 
                                class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent">
                            <option value="split" {{ old('layout_style', 'split') == 'split' ? 'selected' : '' }}>Split (Text + Image)</option>
                            <option value="centered" {{ old('layout_style') == 'centered' ? 'selected' : '' }}>Centered (Text Only)</option>
                            <option value="full-width" {{ old('layout_style') == 'full-width' ? 'selected' : '' }}>Full Width (Background Image)</option>
                        </select>
                        @error('layout_style')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                ...
                <div class="mt-6">
                    ...
                    <input type="file" 
                           ...
                           accept="image/*"
                           class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black focus:border-transparent">
                    <p class="mt-1 text-sm text-gray-500">Upload a hero image (JPG, PNG, WebP). Recommended size: 1200x800px or larger.</p>
                    @error('hero_image')
                        <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                    @enderror
                </div>
