                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="space-y-4">
                        <label class="flex items-center">
                            <input type="checkbox" name="email_marketing_consent" value="1" {{ old('email_marketing_consent') ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                            <span class="ml-2 text-sm text-gray-700">Email Marketing Consent</span>
                        </label>

                        <label class="flex items-center">
                            <input type="checkbox" name="sms_marketing_consent" value="1" {{ old('sms_marketing_consent') ? 'checked' : '' }}
                                   class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
