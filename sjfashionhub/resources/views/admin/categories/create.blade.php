<x-layouts.admin>
    <x-slot name="title">Create Category - SJ Fashion Hub Admin</x-slot>
    <x-slot name="description">Create a new product category</x-slot>
    <x-slot name="pageTitle">📂 Create New Category</x-slot>
