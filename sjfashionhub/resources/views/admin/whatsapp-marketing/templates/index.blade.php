...
<div class="container mx-auto px-4 py-6">
    ...
    <div class="flex justify-between items-center mb-6">
        ...
        <div class="flex gap-3">
            ...
            @if($templates->whereIn('status', ['pending', 'rejected'])->count() > 0)
            <button onclick="syncAllTemplates()"
...
function syncAllTemplates() {
    if (!confirm('This will check the status of all pending and rejected templates from Meta. Continue?')) {
        return;
    }
    ...
    fetch('/admin/whatsapp-marketing/templates/sync-all', {
        method: 'POST',
        headers: {
            'X-CSRF-TOKEN': document.querySelector('meta[name="csrf-token"]').content,
            'Accept': 'application/json',
