                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <select id="page_type" name="page_type" 
                                    ...
                                    <option value="custom" {{ old('page_type', $page->page_type) === 'custom' ? 'selected' : '' }}>Custom Page</option>
                                    <option value="about" {{ old('page_type', $page->page_type) === 'about' ? 'selected' : '' }}>About Us</option>
                                    <option value="contact" {{ old('page_type', $page->page_type) === 'contact' ? 'selected' : '' }}>Contact Us</option>
                                    <option value="privacy" {{ old('page_type', $page->page_type) === 'privacy' ? 'selected' : '' }}>Privacy Policy</option>
                                    <option value="terms" {{ old('page_type', $page->page_type) === 'terms' ? 'selected' : '' }}>Terms of Service</option>
                                    <option value="shipping" {{ old('page_type', $page->page_type) === 'shipping' ? 'selected' : '' }}>Shipping Policy</option>
                                    <option value="returns" {{ old('page_type', $page->page_type) === 'returns' ? 'selected' : '' }}>Return Policy</option>
                ...
                <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="pt-4 border-t border-gray-200">
                                <div class="text-sm text-gray-600 space-y-1">
                                    ...
                                    <p><strong>Updated:</strong> {{ $page->updated_at->format('M d, Y g:i A') }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <textarea id="meta_description" name="meta_description" rows="3" 
                                          maxlength="160" class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">{{ old('meta_description', $page->meta_description) }}</textarea>
                    ...
                    <div class="bg-white rounded-lg shadow p-6">
                        <div class="flex flex-col space-y-3">
                            ...
                            <a href="{{ route('admin.pages.show', $page) }}" class="w-full bg-green-600 hover:bg-green-700 text-white py-2 px-4 rounded-lg text-center transition-colors">
                                <i class="fas fa-eye mr-2"></i>View Page
                            </a>
                            <a href="/{{ $page->slug }}" target="_blank" class="w-full bg-gray-600 hover:bg-gray-700 text-white py-2 px-4 rounded-lg text-center transition-colors">
                                <i class="fas fa-external-link-alt mr-2"></i>Preview Live
                            </a>
