<x-layouts.mobileadmin>
    <div class="p-6">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600 mt-1">Add a new promotional banner to the app</p>
        </div>

        <form action="{{ route('mobileadmin.banners.store') }}" method="POST" enctype="multipart/form-data">
            @csrf
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="md:col-span-2">
                        <label for="image" class="block text-sm font-medium text-gray-700 mb-2">
                            Banner Image * <span class="text-gray-500 text-xs">(Recommended: 1200x400px)</span>
                        </label>
                        <input type="file" 
                               id="image" 
                               name="image" 
                    ...
                    <div>
                        ...
                        <select id="link_type" 
                            ...
                            <option value="screen" {{ old('link_type') == 'screen' ? 'selected' : '' }}>App Screen</option>
                        </select>
                        @error('link_type')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
