<x-layouts.user title="Add New Address" subtitle="Add a new shipping or billing address">
    <div class="max-w-2xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="mb-6">
            ...
            <p class="text-gray-600">Fill in the details below to add a new address to your account.</p>
        </div>
            ...
            <form method="POST" action="{{ route('user.addresses.store') }}">
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        ...
                        <label class="relative">
                            <input type="radio" name="type" value="both" class="sr-only peer">
                ...
                <div class="mb-6">
                    ...
                    <textarea id="address_line_1" 
                              ...
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-black">{{ old('address_line_1') }}</textarea>
                ...
                <div class="mb-6">
                    ...
                    <textarea id="address_line_2" 
                              ...
                              class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:ring-2 focus:ring-black focus:border-black">{{ old('address_line_2') }}</textarea>
