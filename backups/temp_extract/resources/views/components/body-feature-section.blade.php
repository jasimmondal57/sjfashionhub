                            ...
                            <div class="bg-white rounded-lg shadow-sm border border-gray-100 overflow-hidden group hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                                ...
                                <div class="p-3 md:p-4">
                                    ...
                                    <div class="flex flex-col md:flex-row space-y-2 md:space-y-0 md:space-x-2">
                                        <button onclick="addToCartWithAnimation({{ $item->id }}, this)" class="cart-button flex-1 text-xs md:text-sm py-2 px-3 rounded transition-colors bg-gray-900 text-white hover:bg-gray-800">
                                            <span class="button-text">Add to Cart</span>
                                            <span class="loading-text" style="display: none;">Adding...</span>
                                            <span class="success-text" style="display: none;">Added! ✓</span>
                                        </button>
                                        <button onclick="buyNow({{ $item->id }})" class="flex-1 text-xs md:text-sm py-2 px-3 rounded transition-colors bg-blue-600 text-white hover:bg-blue-700">
                                            Buy Now
                                        </button>
                                    </div>
                                </div>
