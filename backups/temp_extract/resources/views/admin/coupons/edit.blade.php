            ...
            <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6 mb-6">
                <div class="flex items-center justify-between">
                    <div>
                        ...
                        <p class="text-gray-600 mt-1">Update coupon: {{ $coupon->code }}</p>
                    </div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="description" id="description" rows="3" 
                                      ...
                                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">{{ old('description', $coupon->description) }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                        ...
                        <div>
                            ...
                            <input type="number" name="usage_limit_per_customer" id="usage_limit_per_customer" value="{{ old('usage_limit_per_customer', $coupon->usage_limit_per_customer) }}" 
                                   min="1" placeholder="Unlimited"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
                        ...
                        <div>
                            ...
                            <div class="px-3 py-2 bg-gray-50 border border-gray-300 rounded-md">
                                <span class="text-sm font-medium">{{ $coupon->used_count }}</span>
                                @if($coupon->usage_limit)
                                    <span class="text-sm text-gray-500">/ {{ $coupon->usage_limit }}</span>
                                @else
                ...
                <div class="bg-white rounded-lg shadow-sm border border-gray-100 p-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="space-y-4">
                            ...
                            <label class="flex items-center">
                                <input type="checkbox" name="stackable" value="1" {{ old('stackable', $coupon->stackable) ? 'checked' : '' }}
                                       class="rounded border-gray-300 text-blue-600 shadow-sm focus:border-blue-300 focus:ring focus:ring-blue-200 focus:ring-opacity-50">
                        ...
                        <div>
                            ...
                            <input type="number" name="priority" id="priority" value="{{ old('priority', $coupon->priority) }}" 
                                   min="0" placeholder="0"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500">
